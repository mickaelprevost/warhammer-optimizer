 ...
 */
final class Version20240620080034 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE itemstype_items (itemstype_id INT NOT NULL, items_id INT NOT NULL, INDEX IDX_DE255BA06BB0AE84 (items_id), INDEX IDX_DE255BA060C8DDDE (itemstype_id), PRIMARY KEY(itemstype_id, items_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
